...
(
    id_user_telegram_data  INTEGER UNSIGNED AUTO_INCREMENT NOT NULL,
...
(
    id_user                INTEGER UNSIGNED AUTO_INCREMENT NOT NULL,
...
(
    id_location  INTEGER UNSIGNED AUTO_INCREMENT NOT NULL,
...
(
    id_event_data       INTEGER UNSIGNED AUTO_INCREMENT NOT NULL,
    id_event            INTEGER UNSIGNED NOT NULL,
...
(
    id_event_program        INTEGER UNSIGNED AUTO_INCREMENT NOT NULL,
    id_event                INTEGER UNSIGNED NOT NULL,
...
(
    id_event_program_i18n       INTEGER UNSIGNED AUTO_INCREMENT NOT NULL,
...
(
    id_event_rule       INTEGER UNSIGNED AUTO_INCREMENT NOT NULL,
    id_event            INTEGER UNSIGNED NOT NULL,
    position            INTEGER UNSIGNED NOT NULL DEFAULT 0,
...
(
    id_event_rule_i18n      INTEGER UNSIGNED AUTO_INCREMENT NOT NULL,
